...
const projects = [
  {
    ...
    category: "Frontend",
    description:
      "Lorem ipsum dolor sit amet consectetur adipisicing elit. Cumque, iusto reiciendis blanditiis voluptatibus, voluptates laboriosam nostrum amet autem natus dignissimos hic? Explicabo nulla alias qui animi repellat dolores voluptatibus distinctio!",
                ...
                <Link href={project.github}>
                  <TooltipProvider delayDuration={100}>
                    <Tooltip>
                      ...
                      flex justify-center items-center group"
                      >
                        <BsGithub className="text-white text-3x group-hover:text-accent" />
                      </TooltipTrigger>
                      <TooltipContent>
